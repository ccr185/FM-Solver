...
def main(constraints):
    # root, f1, f2, f3, f4, f5, f6, f7, f8, f9 = Bools('root, f1, f2, f3, f4, f5, f6, f7, f8, f9')
    # constraints = []
    # constraints.extend([root == True, root == f1, f6 == f1, f5 == f1, f4 == f8])
    # constraints.extend([AtLeast(f2,f3,f4,1),AtMost(f2,f3,f4,1)])
    # constraints.extend([Implies(f9,f4),Implies(f7,f3),Implies(f8,f7),Implies(f5,f9)])
...
class SubsetSolver:
   ...
   def __init__(self, constraints):
       ...
       #self.s.set("sat.cardinality.solver", True)
